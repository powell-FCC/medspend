-- Phase 5A.8B performance hotfix:
-- Keep raw_data out of the common structured-specification path and inspect
-- Raw Product Block only for products with no structured variant.

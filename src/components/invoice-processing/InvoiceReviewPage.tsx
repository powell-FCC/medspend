...
export function InvoiceReviewPage({ sourceFileId }: { sourceFileId: string }) {
  ...
  return <div className="mx-auto max-w-7xl px-5 py-8 sm:px-8">
    ...
    {data.header.documentTextStatus === 'success' && <Alert className="mb-5 border-emerald-200 bg-emerald-50"><CheckCircle2 className="text-emerald-700" /><AlertTitle>Document text extracted successfully.</AlertTitle><AlertDescription>Embedded text is available for future invoice structuring. Review and enter invoice details as usual.</AlertDescription></Alert>}

...
import { LayoutDashboard, Upload, ShoppingCart, FileText, Package, Building2, ClipboardList, Settings, LogOut, Building } from "lucide-react";
...
const nav = [
  ...
  { to: "/supply-requests", label: "Supply Requests", icon: ClipboardList },
